...
export default function MemberSettingsIndex({
  user,
  profile,
  error,
  ...
  const submitProfile = (e: React.FormEvent) => {
    ...
    router.put('/member/settings', { displayName }, { onFinish: () => setProfileSaving(false) })
  }
  ...
  const submitRevokeAllSessions = (e: React.FormEvent) => {
    ...
    setRevokingAll(true)
    router.post(
      '/member/settings/sessions/revoke-all',
      {},
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <aside className="lg:col-span-1">
              ...
              >
                <Button
                  ...
                  id="member-settings-tab-account"
                  aria-controls="member-settings-panel-account"
                ...
                <Button
                  ...
                  id="member-settings-tab-security"
                  aria-controls="member-settings-panel-security"
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {activeTab === 'account' && (
                <Card
                  id="member-settings-panel-account"
                  role="tabpanel"
                  aria-labelledby="member-settings-tab-account"
                  ...
                  <CardContent className="p-6">
                    <form onSubmit={submitProfile} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        {error && (
                          <p className="flex items-center gap-1 font-sans text-xs text-red-400">
                            ...
                            {t('ui.manager.settings.loadFailedRetry')}
                          </p>
                        )}
                      </div>
                      <div className="space-y-2">
                        <label
                          htmlFor="member-settings-email"
                          className="font-mono text-[10px] uppercase tracking-wider text-zinc-500"
                        >
                          {t('ui.member.settings.emailLabel')}
                        </label>
                        <Input
                          id="member-settings-email"
                          readOnly
                          className="rounded-none border-zinc-800 bg-zinc-950/50 font-sans text-zinc-400 focus:ring-0"
                          value={user.email}
                        />
                      </div>
                      <div className="space-y-2">
                        <label
                          htmlFor="member-settings-role"
                          className="font-mono text-[10px] uppercase tracking-wider text-zinc-500"
                        >
                          {t('ui.member.settings.roleLabel')}
                        </label>
                        <Input
                      ...
                      <div className="flex justify-end">
                        ...
                        >
                          {profileSaving
                            ? t('ui.member.settings.submitLoading')
                            : t('ui.member.settings.submitButton')}
                        </Button>
                      </div>
                    </form>
                  </CardContent>
              ...
              {activeTab === 'security' && (
                <>
                  <Card
                    id="member-settings-panel-security"
                    role="tabpanel"
                    aria-labelledby="member-settings-tab-security"
                    className="rounded-none border-zinc-800 bg-zinc-900 shadow-none"
                  >
                    <CardHeader className="border-b border-zinc-800 px-6 py-4">
                      <div className="flex items-center gap-2 text-zinc-100">
                    ...
                    <CardContent className="p-6">
                      <form onSubmit={submitPassword} className="space-y-6">
                        ...
                        <div className="space-y-2">
                          <label
                            htmlFor="member-settings-current-password"
                            className="font-mono text-[10px] uppercase tracking-wider text-zinc-500"
                          >
                        ...
                        <div className="space-y-2">
                          <label
                            htmlFor="member-settings-new-password"
                            className="font-mono text-[10px] uppercase tracking-wider text-zinc-500"
                          >
                          ...
                          <div className="pt-2">
                            ...
                            <div className="mt-2 flex items-center justify-between">
                              ...
                              <ul className="flex gap-3 font-sans text-[9px] text-zinc-600">
                                ...
                                >
                                  {t('ui.manager.settings.passwordHintShortMin', {
                        ...
                        <div className="space-y-2">
                          <label
                            htmlFor="member-settings-confirm-password"
                            className="font-mono text-[10px] uppercase tracking-wider text-zinc-500"
                          >
                              ...
                              {sessions.map((s) => (
                                ...
                                >
                                  <td className="px-3 py-2">
                                    {formatSessionTime(s.createdAt, locale)}
                                  </td>
                                  <td className="px-3 py-2">
                                    {formatSessionTime(s.expiresAt, locale)}
                                  </td>
                                  <td className="px-3 py-2">
                                    {s.isCurrent ? (
