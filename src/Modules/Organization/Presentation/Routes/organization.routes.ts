...
export async function registerOrganizationRoutes(
	...
	router.post('/api/organizations/:id/invitations', [requireOrganizationContext()], (ctx) => controller.invite(ctx))
	router.get('/api/organizations/:id/invitations', [requireOrganizationContext()], (ctx) => controller.listInvitations(ctx))
	router.delete('/api/organizations/:id/invitations/:invId', [requireOrganizationContext()], (ctx) =>
	...
	router.patch('/api/organizations/:id/members/:userId/role', [createRoleMiddleware('admin'), requireOrganizationContext()], (ctx) =>
