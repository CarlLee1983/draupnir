...
export class ApiKeyServiceProvider extends ModuleServiceProvider implements IRouteRegistrar {
  ...
  protected override registerApplicationServices(container: IContainer): void {
    ...
    container.bind(
      'listApiKeysService',
      (c: IContainer) =>
        new ListApiKeysService(
          c.make('apiKeyRepository') as IApiKeyRepository,
          c.make('orgAuthorizationHelper') as OrgAuthorizationHelper,
        ),
    )
    container.bind(
      'sumQuotaAllocatedForOrgService',
      (c: IContainer) =>
    ...
    container.bind(
      'updateKeyLabelService',
      (c: IContainer) =>
        new UpdateKeyLabelService(
          c.make('apiKeyRepository') as IApiKeyRepository,
          c.make('orgAuthorizationHelper') as OrgAuthorizationHelper,
        ),
    )
    container.bind(
      'setKeyPermissionsService',
      (c: IContainer) =>
        new SetKeyPermissionsService(
          c.make('apiKeyRepository') as IApiKeyRepository,
          c.make('orgAuthorizationHelper') as OrgAuthorizationHelper,
          c.make('apiKeyBifrostSync') as ApiKeyBifrostSync,
        ),
    ...
    container.bind(
      'updateApiKeyBudgetService',
      (c: IContainer) =>
        new UpdateApiKeyBudgetService(
          c.make('apiKeyRepository') as IApiKeyRepository,
          c.make('orgAuthorizationHelper') as OrgAuthorizationHelper,
          c.make('apiKeyBifrostSync') as ApiKeyBifrostSync,
        ),
