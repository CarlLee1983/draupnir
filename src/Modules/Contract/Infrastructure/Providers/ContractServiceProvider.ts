import type { ApiKeyRepository } from '@/Modules/ApiKey/Infrastructure/Repositories/ApiKeyRepository'
...
export class ContractServiceProvider extends ModuleServiceProvider implements IRouteRegistrar {
  protected override registerRepositories(container: IContainer): void {
    container.singleton(
      'contractRepository',
      () => new ContractRepository(getCurrentDatabaseAccess()),
    )
  }
  ...
  protected override registerApplicationServices(container: IContainer): void {
    ...
    container.bind(
      'getActiveOrgContractQuotaService',
      (c: IContainer) =>
